...
dmc3_items: dict[str, ItemData] = {
    ...
    "Purple Orb": ItemData("Purple Orb", 0x08, ItemClassification.useful, item_descriptions["N/A"], mode=Mode.CONSUMABLE),
    "Blue Orb Fragment": ItemData("Blue Orb Fragment", 0x09, ItemClassification.useful, item_descriptions["N/A"], mode=Mode.CONSUMABLE),

    # Consumables
    "Vital Star L": ItemData("Vital Star L", 0x10, ItemClassification.filler, item_descriptions["N/A"], mode=Mode.CONSUMABLE),
    "Vital Star S": ItemData("Vital Star S", 0x11, ItemClassification.filler, item_descriptions["N/A"], mode=Mode.CONSUMABLE),
    "Devil Star": ItemData("Devil Star", 0x12, ItemClassification.filler, item_descriptions["N/A"], mode=Mode.CONSUMABLE),
    "Holy Water": ItemData("Holy Water", 0x13, ItemClassification.filler, item_descriptions["N/A"], mode=Mode.CONSUMABLE),

    # Melee
    "Rebellion (Normal)": ItemData("Rebellion (Normal)", 0x16, ItemClassification.useful, item_descriptions["N/A"], mode=Mode.KEY),
    "Cerberus": ItemData("Cerberus", 0x17, ItemClassification.useful, item_descriptions["N/A"], mode=Mode.KEY),
    "Agni and Rudra": ItemData("Agni and Rudra", 0x18, ItemClassification.useful, item_descriptions["N/A"], mode=Mode.KEY),
    # Tie Awakened Rebellion to DT unlock?
    "Rebellion (Awakened)": ItemData("Rebellion (Awakened)", 0x19, ItemClassification.useful, item_descriptions["N/A"], mode=Mode.KEY),
    ...
    # Guns
    "Ebony & Ivory": ItemData("Ebony & Ivory", 0x1C, ItemClassification.useful, item_descriptions["N/A"], mode=Mode.KEY),
    ...
    # Key items
    "Astronomical Board": ItemData("Astronomical Board", 0x24, ItemClassification.progression, item_descriptions["Astronomical Board"], mode=Mode.KEY),
    ...
    "Soul of Steel": ItemData("Soul of Steel", 0x27, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Essence of Fighting": ItemData("Essence of Fighting", 0x28, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Essence of Technique": ItemData("Essence of Technique", 0x29, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    ...
    "Orihalcon Fragment": ItemData("Orihalcon Fragment", 0x2B, ItemClassification.progression,
                                   item_descriptions["N/A"], mode=Mode.KEY),
    "Siren's Shriek": ItemData("Siren's Shriek", 0x2C, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Crystal Skull": ItemData("Crystal Skull", 0x2D, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Ignis Fatuus": ItemData("Ignis Fatuus", 0x2E, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    ...
    "Neo Generator": ItemData("Neo Generator", 0x31, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Haywire Neo Generator": ItemData("Haywire Neo Generator", 0x32, ItemClassification.progression,
                                      item_descriptions["N/A"], mode=Mode.KEY),
    "Full Orihalcon": ItemData("Full Orihalcon", 0x33, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Orihalcon Fragment (Right)": ItemData("Orihalcon Fragment (Right)", 0x34, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Orihalcon Fragment (Bottom)": ItemData("Orihalcon Fragment (Bottom)", 0x35, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Orihalcon Fragment (Left)": ItemData("Orihalcon Fragment (Left)", 0x36, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Golden Sun": ItemData("Golden Sun", 0x37, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
    "Onyx Moonshard": ItemData("Onyx Moonshard", 0x38, ItemClassification.progression, item_descriptions["N/A"], mode=Mode.KEY),
