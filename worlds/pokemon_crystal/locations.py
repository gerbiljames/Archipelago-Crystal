...
LOCATION_GROUPS = {
    ...
    "Digletts Cave": {loc.label for loc in data.locations.values() if "DiglettDig" in loc.tags},
    "Dragons Den": {loc.label for loc in data.locations.values() if "Dragon" in loc.tags},
    ...
    "Mount Moon": {loc.label for loc in data.locations.values() if "Moon" in loc.tags},
    ...
    "Tohjo Falls": {loc.label for loc in data.locations.values() if "Tohjo" in loc.tags},
